...
import lineageos.preference.LineageGlobalSettingSwitchPreference;

import com.android.settings.R;

public class RisingGlobalSettingSwitchPreference extends LineageGlobalSettingSwitchPreference {

    private Position position;

    public RisingGlobalSettingSwitchPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public RisingGlobalSettingSwitchPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
